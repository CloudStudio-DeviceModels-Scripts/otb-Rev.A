...
# Parsing + Configuration Script – otb - Rev. A

This **Parsing + Configuration** script is designed for the **otb** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – otb Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **otb** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
